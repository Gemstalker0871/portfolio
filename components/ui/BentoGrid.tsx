    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        <div className={cn(
          ...
          <div className="font-jetbrains font-extralight md:max-w-32 md:text-xs lg:text-base text-sm text-[#C1C2D3] z-10">
            {description}
          </div>
          <div className="font-jetbrains text-lg lg:text-3xl max-w-96 font-bold z-10">
          {title}
        </div>
