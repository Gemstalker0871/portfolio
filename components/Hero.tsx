      ...
      <div className="flex flex-col sm:flex-row justify-center items-center relative my-20 z-10 gap-10 -mt-10">
        <div className="flex justify-center relative my-20 z-10 items-start md:items-start">
          <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center md:items-start justify-center">
            <h2 className="uppercase tracking-widest text-xs text-center md:text-left text-black-100 max-w-80">
              Technology • Design • Data
              {/* theme change changed text-blue-100 to text-black-100 and Coding Enthusiast to Technology • Design • Data*/}
            </h2>
            ...
            <div className="flex gap-4 mt-4">
              ...
              <a
                target="_blank"
                href="https://drive.google.com/file/d/1d9INmPZ2fdiEUKpz7HyQOHE17hILkNZo/view?usp=sharing"
              >
                <MagicButton
                  title="See my resume"
                  icon={<FaDownload />}
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center z-10 py-6 md:py-0">
          <div
            className="w-full sm:w-[80%] max-w-[300px] sm:max-w-[500px] md:max-w-[600px] lg:max-w-[700px] relative overflow-hidden p-[2px]"
