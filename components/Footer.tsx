  ...
  return (
    <footer className='w-full pb-10 mb-[100px] md:mb-5' id="contact">
        ...
        <div className='flex flex-col items-center'>
            ...
            <a href="resume.com"> <MagicButton title='My Resume' icon={<FaLocationArrow />} position='right' /></a>
        </div>
        <div className='flex mt-16 md:flex-row flex-col justify-between items-center'>
            <p className='md:text-base text-sm md:font-normal font-light'>Copyright @ 2025 Sambahv</p>
